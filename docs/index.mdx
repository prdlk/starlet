---
title: Starlet
description: A local-first desktop search engine for your GitHub stars — native Rust, GPUI, SQLite. This is the developer documentation: how the workspace is laid out, why it is laid out that way, and where to touch it.
---
