---
title: "6. SQLite: WAL, an owned FTS5 table, and three separate tag sources"
description: Run SQLite in WAL mode with a content-owning FTS5 index, and keep GitHub, AI, and user tags as separately owned sources.
sidebar:
  label: "6. SQLite schema"
---
