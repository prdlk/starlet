---
title: "9. BYOK AI: one provider trait, strict JSON, one retry"
description: Put every AI provider behind one trait, parse model JSON strictly while sanitising values, and retry a parse failure exactly once.
sidebar:
  label: "9. BYOK AI"
---
