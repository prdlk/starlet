---
title: "10. The palette is a theme file, and the app carries its own assets"
description: Define every colour in one theme JSON read through cx.theme(), and embed the icons and fonts with a build script.
sidebar:
  label: "10. Theme as tokens"
---
