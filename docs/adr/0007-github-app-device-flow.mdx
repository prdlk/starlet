---
title: "7. GitHub App device flow, token in the OS keychain"
description: Authenticate as a GitHub App through the device flow, so there is no client secret to embed, and keep the resulting token only in the OS keychain.
sidebar:
  label: "7. GitHub App device flow"
---
