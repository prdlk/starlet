---
title: Sync pipeline
description: Full and incremental sync — pagination, the star watermark, the GraphQL count check that catches unstars, conditional metadata refresh, and the language backfill.
sidebar:
  label: Sync pipeline
  icon: refresh-cw
---
